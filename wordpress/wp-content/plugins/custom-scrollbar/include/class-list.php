...
$_aClassFiles = array( 
	...
	"CustomScrollbar_AdminPage_Setting__Data"	=>	CustomScrollbar_Registry::$sDirPath . "/include/class/admin/setting/data/CustomScrollbar_AdminPage_Setting__Data.php", 
	"CustomScrollbar_AdminPage_Setting__Data__Import"	=>	CustomScrollbar_Registry::$sDirPath . "/include/class/admin/setting/data/CustomScrollbar_AdminPage_Setting__Data__Import.php", 
	"CustomScrollbar_AdminPage_Setting__Data__Reset"	=>	CustomScrollbar_Registry::$sDirPath . "/include/class/admin/setting/data/CustomScrollbar_AdminPage_Setting__Data__Reset.php", 
	"CustomScrollbar_AdminPage_Setting__Data__Transport"	=>	CustomScrollbar_Registry::$sDirPath . "/include/class/admin/setting/data/CustomScrollbar_AdminPage_Setting__Data__Transport.php", 

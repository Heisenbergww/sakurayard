...
abstract class CustomScrollbar_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('CustomScrollbar_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new CustomScrollbar_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }

...
class CustomScrollbar_AdminPageFramework_FieldType_text extends CustomScrollbar_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".custom-scrollbar-field.custom-scrollbar-field-text > .custom-scrollbar-input-label-container {vertical-align: middle; }.custom-scrollbar-field.custom-scrollbar-field-text > .custom-scrollbar-input-label-container.custom-scrollbar-field-text-multiple-labels {display: block;}";
    }
    ...
    private function _getFieldOutputByLabel($sKey, $sLabel, $aField) {
        ...
        $_aOutput = array($this->getElementByLabel($aField['before_label'], $sKey, $aField['label']), "<div class='custom-scrollbar-input-label-container {$_sClassSelector}'>", "<label for='" . $_aInputAttributes['id'] . "'>", $this->getElementByLabel($aField['before_input'], $sKey, $aField['label']), $_sLabel ? "<span " . $this->getLabelContainerAttributes($aField, 'custom-scrollbar-input-label-string') . ">" . $_sLabel . "</span>" : '', "<input " . $this->getAttributes($_aInputAttributes) . " />", $this->getElementByLabel($aField['after_input'], $sKey, $aField['label']), "</label>", "</div>", $this->getElementByLabel($aField['after_label'], $sKey, $aField['label']),);
        return implode('', $_aOutput);
    }
}
class CustomScrollbar_AdminPageFramework_FieldType_file extends CustomScrollbar_AdminPageFramework_FieldType_text {

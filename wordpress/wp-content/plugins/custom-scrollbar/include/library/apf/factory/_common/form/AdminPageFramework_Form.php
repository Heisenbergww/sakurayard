...
abstract class CustomScrollbar_AdminPageFramework_Form_Utility extends CustomScrollbar_AdminPageFramework_FrameworkUtility {
    ...
    static public function getFieldsetReformattedBySubFieldIndex(array $aFieldset, $iSubFieldIndex, $bHasSubFields, array $aParentFieldset) {
        ...
        $_oFieldsetFormatter = new CustomScrollbar_AdminPageFramework_Form_Model___Format_Fieldset($aFieldset, $aFieldset['_structure_type'], $aFieldset['capability'], ( integer )$iSubFieldIndex + 1, $aFieldset['_subsection_index'], $aFieldset['_is_section_repeatable'], $aFieldset['_caller_object']);
        $aFieldset = $_oFieldsetFormatter->get();
        $_oFieldsetOutputFormatter = new CustomScrollbar_AdminPageFramework_Form_Model___Format_FieldsetOutput($aFieldset, $aFieldset['_section_index'], $_oCallerForm->aFieldTypeDefinitions);
...
abstract class CustomScrollbar_AdminPageFramework_Form_Base extends CustomScrollbar_AdminPageFramework_Form_Utility {
...
class CustomScrollbar_AdminPageFramework_Form_Model extends CustomScrollbar_AdminPageFramework_Form_Base {
    ...
    public function getSortedInputs(array $aFormInputs) {
        ...
        $_oInputSorter = new CustomScrollbar_AdminPageFramework_Form_Model___Modifier_SortInput($aFormInputs, $_aDynamicFieldAddressKeys);
    ...
    public function dropRepeatableElements(array $aSubject) {
        $_oFilterRepeatableElements = new CustomScrollbar_AdminPageFramework_Form_Model___Modifier_FilterRepeatableElements($aSubject, $this->getElementAsArray($_POST, '__repeatable_elements_' . $this->aArguments['structure_type']));
    ...
    public function _replyToRegisterFormItems() {
        ...
        $_oFieldResources = new CustomScrollbar_AdminPageFramework_Form_Model___SetFieldResources($this->aArguments, $this->aFieldsets, self::$_aResources, $this->aFieldTypeDefinitions, $this->aCallbacks);
    ...
    private function _setSiteWideFieldTypeDefinitions() {
        ...
        $_oBuiltInFieldTypeDefinitions = new CustomScrollbar_AdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions('admin_page_framework', $this->oMsg);
    ...
    public function getDefaultFormValues() {
        $_oDefaultValues = new CustomScrollbar_AdminPageFramework_Form_Model___DefaultValues($this->aFieldsets);
        return $_oDefaultValues->get();
    }
    protected function _formatElementDefinitions(array $aSavedData) {
        $_oSectionsetsFormatter = new CustomScrollbar_AdminPageFramework_Form_Model___FormatSectionsets($this->aSectionsets, $this->aArguments['structure_type'], $this->sCapability, $this->aCallbacks, $this);
        $this->aSectionsets = $_oSectionsetsFormatter->get();
        $_oFieldsetsFormatter = new CustomScrollbar_AdminPageFramework_Form_Model___FormatFieldsets($this->aFieldsets, $this->aSectionsets, $this->aArguments['structure_type'], $this->aSavedData, $this->sCapability, $this->aCallbacks, $this);
...
class CustomScrollbar_AdminPageFramework_Form_Controller extends CustomScrollbar_AdminPageFramework_Form_View {
...
class CustomScrollbar_AdminPageFramework_Form extends CustomScrollbar_AdminPageFramework_Form_Controller {
    ...
    public function __construct() {
        ...
        $this->oSubmitNotice = new CustomScrollbar_AdminPageFramework_Form___SubmitNotice;
        $this->oFieldError = new CustomScrollbar_AdminPageFramework_Form___FieldError($this->aArguments['caller_id']);
        $this->oLastInputs = new CustomScrollbar_AdminPageFramework_Form_Model___LastInput($this->aArguments['caller_id']);
        parent::__construct();
        $this->construct();
    }

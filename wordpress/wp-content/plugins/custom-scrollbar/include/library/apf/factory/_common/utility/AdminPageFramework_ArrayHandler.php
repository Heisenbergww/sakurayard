...
class CustomScrollbar_AdminPageFramework_FrameworkUtility extends CustomScrollbar_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = CustomScrollbar_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return CustomScrollbar_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
}
class CustomScrollbar_AdminPageFramework_ArrayHandler extends CustomScrollbar_AdminPageFramework_FrameworkUtility {
    public $aData = array();

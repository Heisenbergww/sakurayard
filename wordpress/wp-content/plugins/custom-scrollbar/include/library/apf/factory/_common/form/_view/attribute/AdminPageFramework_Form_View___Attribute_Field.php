...
abstract class CustomScrollbar_AdminPageFramework_Form_View___Attribute_Base extends CustomScrollbar_AdminPageFramework_Form_Utility {
    public $sContext = '';
...
abstract class CustomScrollbar_AdminPageFramework_Form_View___Attribute_FieldContainer_Base extends CustomScrollbar_AdminPageFramework_Form_View___Attribute_Base {
    protected function _getFormattedAttributes() {
...
class CustomScrollbar_AdminPageFramework_Form_View___Attribute_Field extends CustomScrollbar_AdminPageFramework_Form_View___Attribute_FieldContainer_Base {
    ...
    protected function _getAttributes() {
        $_sFieldTypeSelector = $this->getAOrB($this->aArguments['type'], " custom-scrollbar-field-{$this->aArguments['type']}", '');
        ...
        return array('id' => $this->aArguments['_field_container_id'], 'data-type' => $this->aArguments['type'], 'class' => "custom-scrollbar-field{$_sFieldTypeSelector}{$_sNestedFieldSelector}{$_sMixedFieldSelector}{$_sChildFieldSelector}" . $this->getAOrB($this->aArguments['attributes']['disabled'], ' disabled', '') . $this->getAOrB($this->aArguments['_is_sub_field'], ' custom-scrollbar-subfield', ''));
    }
}

...
abstract class CustomScrollbar_AdminPageFramework_Utility_Deprecated {
...
abstract class CustomScrollbar_AdminPageFramework_Utility_VariableType extends CustomScrollbar_AdminPageFramework_Utility_Deprecated {
...
abstract class CustomScrollbar_AdminPageFramework_Utility_String extends CustomScrollbar_AdminPageFramework_Utility_VariableType {
    ...
    static public function minifyCSS($sCSSRules) {
        trigger_error(CustomScrollbar_AdminPageFramework_Registry::NAME . ': ' . sprintf('The method, %1$s, is deprecated. Use %2$s instead.', 'minifyCSS()', 'getCSSMinified()'), E_USER_NOTICE);
...
abstract class CustomScrollbar_AdminPageFramework_Utility_Array extends CustomScrollbar_AdminPageFramework_Utility_String {
...
abstract class CustomScrollbar_AdminPageFramework_Utility_ArrayGetter extends CustomScrollbar_AdminPageFramework_Utility_Array {
...
abstract class CustomScrollbar_AdminPageFramework_Utility_ArraySetter extends CustomScrollbar_AdminPageFramework_Utility_ArrayGetter {
...
abstract class CustomScrollbar_AdminPageFramework_Utility_Path extends CustomScrollbar_AdminPageFramework_Utility_ArraySetter {
    ...
    static public function getCallerScriptPath($sRedirectedFilePath) {
        ...
        $_sCallerFilePath = '';
        $_aBackTrace = call_user_func_array('debug_backtrace', array(defined('DEBUG_BACKTRACE_IGNORE_ARGS') ? DEBUG_BACKTRACE_IGNORE_ARGS : false, 6,));
...
abstract class CustomScrollbar_AdminPageFramework_Utility_URL extends CustomScrollbar_AdminPageFramework_Utility_Path {
...
abstract class CustomScrollbar_AdminPageFramework_Utility_File extends CustomScrollbar_AdminPageFramework_Utility_URL {
...
abstract class CustomScrollbar_AdminPageFramework_Utility_SystemInformation extends CustomScrollbar_AdminPageFramework_Utility_File {
...
abstract class CustomScrollbar_AdminPageFramework_Utility_HTMLAttribute extends CustomScrollbar_AdminPageFramework_Utility_SystemInformation {
...
class CustomScrollbar_AdminPageFramework_Utility extends CustomScrollbar_AdminPageFramework_Utility_HTMLAttribute {

...
abstract class CustomScrollbar_AdminPageFramework_Router extends CustomScrollbar_AdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'custom-scrollbar') {
        $_sProprtyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'CustomScrollbar_AdminPageFramework_Property_' . $this->_sStructureType;
...
abstract class CustomScrollbar_AdminPageFramework_Model_Form extends CustomScrollbar_AdminPageFramework_Router {
    public $aFieldErrors;
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'custom-scrollbar') {
        ...
        new CustomScrollbar_AdminPageFramework_Model__FormEmailHandler($this);
    ...
    public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        new CustomScrollbar_AdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
    }
...
abstract class CustomScrollbar_AdminPageFramework_View_Form extends CustomScrollbar_AdminPageFramework_Model_Form {
...
abstract class CustomScrollbar_AdminPageFramework_Controller_Form extends CustomScrollbar_AdminPageFramework_View_Form {
    ...
    public function getValue() {
        ...
        return CustomScrollbar_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
    }
...
abstract class CustomScrollbar_AdminPageFramework_Model_Page extends CustomScrollbar_AdminPageFramework_Controller_Form {
...
abstract class CustomScrollbar_AdminPageFramework_Controller_Page extends CustomScrollbar_AdminPageFramework_View_Page {
...
abstract class CustomScrollbar_AdminPageFramework_Model_Menu extends CustomScrollbar_AdminPageFramework_Controller_Page {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'custom-scrollbar') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
        }
        new CustomScrollbar_AdminPageFramework_Model_Menu__RegisterMenu($this);
    }
}
abstract class CustomScrollbar_AdminPageFramework_View_Menu extends CustomScrollbar_AdminPageFramework_Model_Menu {
}
abstract class CustomScrollbar_AdminPageFramework_Controller_Menu extends CustomScrollbar_AdminPageFramework_View_Menu {
    ...
    public function addSubMenuLink(array $aSubMenuLink) {
        ...
        $_oFormatter = new CustomScrollbar_AdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
    ...
    public function addSubMenuPage(array $aSubMenuPage) {
        ...
        $_oFormatter = new CustomScrollbar_AdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
...
abstract class CustomScrollbar_AdminPageFramework_Controller extends CustomScrollbar_AdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
        ...
        new CustomScrollbar_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, '_isInThePage'),));
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return CustomScrollbar_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
abstract class CustomScrollbar_AdminPageFramework extends CustomScrollbar_AdminPageFramework_Controller {
    ...
    private function _getCallerPath($sCallerPath) {
        ...
        $_sCalllerPath = in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page']) ? CustomScrollbar_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;

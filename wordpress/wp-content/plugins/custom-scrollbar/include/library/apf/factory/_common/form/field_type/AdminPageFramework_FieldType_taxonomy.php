...
class CustomScrollbar_AdminPageFramework_FieldType_taxonomy extends CustomScrollbar_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new CustomScrollbar_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        return parent::getScripts() . <<<JAVASCRIPTS
/* For tabs */
var enableCustomScrollbar_AdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enableCustomScrollbar_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registerCustomScrollbar_AdminPageFrameworkCallbacks( {     
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType ) {
            ...
            enableCustomScrollbar_AdminPageFrameworkTabbedBox( jQuery( oCloned ).find( '.tab-box-container' ) );            
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".custom-scrollbar-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.custom-scrollbar-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.custom-scrollbar-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.custom-scrollbar-field .taxonomy-checklist ul ul {margin-left: 1em;}.custom-scrollbar-field .taxonomy-checklist-label {white-space: nowrap; }.custom-scrollbar-field .tab-box-container.categorydiv {max-height: none;}.custom-scrollbar-field .tab-box-tab-text {display: inline-block;}.custom-scrollbar-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.custom-scrollbar-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 2px;background-color: #fff;}.custom-scrollbar-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.custom-scrollbar-field .tab-box-tabs li a { color: #333; text-decoration: none; }.custom-scrollbar-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.custom-scrollbar-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.custom-scrollbar-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.custom-scrollbar-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.custom-scrollbar-field .tab-box-content:target, .custom-scrollbar-field .tab-box-content:target, .custom-scrollbar-field .tab-box-content:target { display: block; }.custom-scrollbar-field .tab-box-content .select_all_button_container, .custom-scrollbar-field .tab-box-content .select_none_button_container{margin-top: 0.8em;}.custom-scrollbar-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
    ...
    private function _getTaxonomyCheckboxes(array $aField, $sKey, $sTaxonomySlug) {
        $_aTabBoxContainerArguments = array('id' => "tab_{$aField['input_id']}_{$sKey}", 'class' => 'tab-box-content', 'style' => $this->generateInlineCSS(array('height' => $this->getAOrB($aField['height'], $this->getLengthSanitized($aField['height']), null), 'width' => $this->getAOrB($aField['width'], $this->getLengthSanitized($aField['width']), null),)),);

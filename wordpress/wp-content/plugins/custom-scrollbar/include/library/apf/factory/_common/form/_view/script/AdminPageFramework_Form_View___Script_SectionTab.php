...
class CustomScrollbar_AdminPageFramework_Form_View___Script_SectionTab extends CustomScrollbar_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.custom-scrollbar-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='custom-scrollbar-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}

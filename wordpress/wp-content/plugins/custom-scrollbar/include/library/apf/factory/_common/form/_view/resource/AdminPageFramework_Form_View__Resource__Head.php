...
class CustomScrollbar_AdminPageFramework_Form_View__Resource__Head extends CustomScrollbar_AdminPageFramework_FrameworkUtility {
    public $oForm;
    ...
    private function _getScripts_RequiredInHead() {
        return 'document.write( "<style class=\'custom-scrollbar-js-embedded-internal-style\'>' . str_replace('\\n', '', esc_js($this->_getInternalCSS())) . '</style>" );';
    }
    ...
    private function _getScriptElementConcealerCSSRules() {
        return ".custom-scrollbar-form-js-on {visibility: hidden;}.widget .custom-scrollbar-form-js-on { visibility: visible; }";
    }
}

...
class CustomScrollbar_AdminPageFramework_Form_View___DebugInfo extends CustomScrollbar_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='custom-scrollbar-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }

...
class CustomScrollbar_AdminPageFramework_FieldType_submit extends CustomScrollbar_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".custom-scrollbar-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'custom-scrollbar-input-label-container' . ' custom-scrollbar-input-button-container' . ' custom-scrollbar-input-container',);
    }
...
class CustomScrollbar_AdminPageFramework_FieldType_export extends CustomScrollbar_AdminPageFramework_FieldType_submit {

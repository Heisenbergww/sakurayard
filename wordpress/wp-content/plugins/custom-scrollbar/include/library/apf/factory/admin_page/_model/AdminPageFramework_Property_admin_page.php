...
class CustomScrollbar_AdminPageFramework_Property_admin_page extends CustomScrollbar_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'custom-scrollbar') {
        ...
        $GLOBALS['aCustomScrollbar_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aCustomScrollbar_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aCustomScrollbar_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;

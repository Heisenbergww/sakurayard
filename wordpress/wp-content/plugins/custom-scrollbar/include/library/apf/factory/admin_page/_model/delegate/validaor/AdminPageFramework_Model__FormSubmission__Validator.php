...
class CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator_Base extends CustomScrollbar_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator extends CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__Link', 'CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__Import', 'CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__Export', 'CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);

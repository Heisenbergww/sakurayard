...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.custom-scrollbar-checkbox-label {margin-top: 0.1em;}.custom-scrollbar-field input[type='checkbox' ] {margin-right: 0.5em;} .custom-scrollbar-field-checkbox .custom-scrollbar-input-label-container {padding-right: 1em;}.custom-scrollbar-field-checkbox .custom-scrollbar-input-label-string{display: inline; }";
    }
...
class CustomScrollbar_AdminPageFramework_FieldType_posttype extends CustomScrollbar_AdminPageFramework_FieldType_checkbox {
    ...
    protected function getStyles() {
        ...
        return $_sParentStyles . ".custom-scrollbar-field input[type='checkbox'] {margin-right: 0.5em;} .custom-scrollbar-field-posttype .custom-scrollbar-input-label-container {padding-right: 1em;}";
    }
    protected function getField($aField) {

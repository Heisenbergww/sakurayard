...
class CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__Filter extends CustomScrollbar_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;

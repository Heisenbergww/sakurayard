...
class CustomScrollbar_AdminPageFramework_FieldType_radio extends CustomScrollbar_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".custom-scrollbar-field input[type='radio'] {margin-right: 0.5em;} .custom-scrollbar-field-radio .custom-scrollbar-input-label-container {padding-right: 1em;} .custom-scrollbar-field-radio .custom-scrollbar-input-container {display: inline;} .custom-scrollbar-field-radio .custom-scrollbar-input-label-string{display: inline; }";
    }

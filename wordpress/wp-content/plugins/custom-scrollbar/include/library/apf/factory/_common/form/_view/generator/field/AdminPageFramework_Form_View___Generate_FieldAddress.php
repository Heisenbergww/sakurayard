...
class CustomScrollbar_AdminPageFramework_Form_View___Generate_FieldName extends CustomScrollbar_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class CustomScrollbar_AdminPageFramework_Form_View___Generate_FlatFieldName extends CustomScrollbar_AdminPageFramework_Form_View___Generate_FieldName {
    public function get() {
...
class CustomScrollbar_AdminPageFramework_Form_View___Generate_FieldAddress extends CustomScrollbar_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public function get() {

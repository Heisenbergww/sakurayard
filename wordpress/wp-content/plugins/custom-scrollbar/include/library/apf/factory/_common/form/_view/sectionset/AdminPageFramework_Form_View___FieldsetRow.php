...
class CustomScrollbar_AdminPageFramework_Form_View___FieldsetTableRow extends CustomScrollbar_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        $_oFieldrowAttribute = new CustomScrollbar_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset, array('id' => 'fieldrow-' . $aFieldset['tag_id'], 'valign' => 'top', 'class' => 'custom-scrollbar-fieldrow',));
    ...
    protected function _getFieldByContainer(array $aFieldset, array $aOpenCloseTags) {
        ...
        $_oFieldTitle = new CustomScrollbar_AdminPageFramework_Form_View___FieldTitle($aFieldset, '', $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        $_aOutput = array();
...
class CustomScrollbar_AdminPageFramework_Form_View___FieldsetRow extends CustomScrollbar_AdminPageFramework_Form_View___FieldsetTableRow {
    public $aFieldset = array();
    public $aSavedData = array();
    public $aFieldErrors = array();
    public $aFieldTypeDefinitions = array();
    ...
    public function get() {
        ...
        $_oFieldrowAttribute = new CustomScrollbar_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset);

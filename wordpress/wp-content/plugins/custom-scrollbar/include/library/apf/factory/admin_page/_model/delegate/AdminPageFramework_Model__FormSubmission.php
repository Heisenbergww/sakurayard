...
abstract class CustomScrollbar_AdminPageFramework_Model__FormSubmission_Base extends CustomScrollbar_AdminPageFramework_FrameworkUtility {
...
class CustomScrollbar_AdminPageFramework_Model__FormSubmission extends CustomScrollbar_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new CustomScrollbar_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);

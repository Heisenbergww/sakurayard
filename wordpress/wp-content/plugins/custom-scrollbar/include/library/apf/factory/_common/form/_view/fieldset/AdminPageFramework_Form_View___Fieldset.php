...
abstract class CustomScrollbar_AdminPageFramework_Form_View___Fieldset_Base extends CustomScrollbar_AdminPageFramework_Form_Utility {
    ...
    private function _getFormatted($aFieldset, $aFieldTypeDefinitions) {
        return $this->uniteArrays($aFieldset, $this->_getFieldTypeDefaultArguments($aFieldset['type'], $aFieldTypeDefinitions) + CustomScrollbar_AdminPageFramework_Form_Model___Format_Fieldset::$aStructure);
    }
    ...
    private function _loadScripts($sStructureType = '') {
        if ('widget' === $sStructureType && !self::$_bIsLoadedJSScripts_Widget) {
            new CustomScrollbar_AdminPageFramework_Form_View___Script_Widget;
        ...
        new CustomScrollbar_AdminPageFramework_Form_View___Script_Utility;
        new CustomScrollbar_AdminPageFramework_Form_View___Script_OptionStorage;
        new CustomScrollbar_AdminPageFramework_Form_View___Script_AttributeUpdator;
        new CustomScrollbar_AdminPageFramework_Form_View___Script_RepeatableField($this->oMsg);
        new CustomScrollbar_AdminPageFramework_Form_View___Script_SortableField;
    }
...
jQuery( document ).ready( function() {
    var _oButtonPlaceHolders = jQuery( '#{$sFieldsContainerID} > .custom-scrollbar-field.without-child-fields .repeatable-field-buttons' );
    ...
    /* Otherwise, insert the button element at the beginning of the field tag */
         ...
         */
        if ( ! jQuery( '#{$sFieldsContainerID} .custom-scrollbar-repeatable-field-buttons' ).length ) { 
            jQuery( '#{$sFieldsContainerID} > .custom-scrollbar-field.without-nested-fields' ).prepend( $_sSmallButtons );
        }
        /**
         * Support for nested fields.
         * For nested fields, add the buttons to the fields tag.
         */
        jQuery( '#{$sFieldsContainerID} > .custom-scrollbar-field.with-nested-fields' ).prepend( $_sNestedFieldsButtons );
        
        /**
         * Support for inline mixed fields.
         */
        // jQuery( '#{$sFieldsContainerID} > .custom-scrollbar-field.with-mixed-fields' ).prepend( $_sNestedFieldsButtons );
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='custom-scrollbar-sortable-field-enabler-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
class CustomScrollbar_AdminPageFramework_Form_View___Fieldset extends CustomScrollbar_AdminPageFramework_Form_View___Fieldset_Base {
    public function get() {
        $_aOutputs = array();
        $_oFieldError = new CustomScrollbar_AdminPageFramework_Form_View___Fieldset___FieldError($this->aErrors, $this->aFieldset['_section_path_array'], $this->aFieldset['_field_path_array'], $this->aFieldset['error_message']);
        $_aOutputs[] = $_oFieldError->get();
        $_oFieldsFormatter = new CustomScrollbar_AdminPageFramework_Form_Model___Format_Fields($this->aFieldset, $this->aOptions);
    ...
    private function _getEachFieldOutput(array $aField, $isIndex, array $aCallbacks, $bIsLastElement = false) {
        ...
        $_oSubFieldFormatter = new CustomScrollbar_AdminPageFramework_Form_Model___Format_EachField($aField, $isIndex, $aCallbacks, $_aFieldTypeDefinition);
    ...
    private function _getFieldOutput($sContent, array $aField, $bIsLastElement) {
        $_oFieldAttribute = new CustomScrollbar_AdminPageFramework_Form_View___Attribute_Field($aField);
    ...
    private function _getFinalOutput(array $aFieldset, array $aFieldsOutput, $iFieldsCount) {
        $_oFieldsetAttributes = new CustomScrollbar_AdminPageFramework_Form_View___Attribute_Fieldset($aFieldset);
    ...
    private function _getEmbeddedFieldTitle(array $aFieldset) {
        ...
        $_oFieldTitle = new CustomScrollbar_AdminPageFramework_Form_View___FieldTitle($aFieldset, '', $this->aOptions, $this->aErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
    ...
    private function _getChildFieldTitle(array $aFieldset) {
        ...
        $_oFieldTitle = new CustomScrollbar_AdminPageFramework_Form_View___FieldTitle($aFieldset, array('custom-scrollbar-child-field-title'), $this->aOptions, $this->aErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        return $_oFieldTitle->get();
    }
    private function _getFieldsetContent($aFieldset, $aFieldsOutput, $iFieldsCount) {
        ...
        $_oFieldsAttributes = new CustomScrollbar_AdminPageFramework_Form_View___Attribute_Fields($aFieldset, array(), $iFieldsCount);
    ...
    private function _getExtras($aField, $iFieldsCount) {
        $_aOutput = array();
        $_oFieldDescription = new CustomScrollbar_AdminPageFramework_Form_View___Description($aField['description'], 'custom-scrollbar-fields-description');

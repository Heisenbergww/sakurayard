...
abstract class CustomScrollbar_AdminPageFramework_Property_Base extends CustomScrollbar_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'custom-scrollbar' : $sTextDomain;
    ...
    private function _setGlobals() {
        if (!isset($GLOBALS['aCustomScrollbar_AdminPageFramework'])) {
            $GLOBALS['aCustomScrollbar_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => CustomScrollbar_AdminPageFramework_Registry::NAME, 'sURI' => CustomScrollbar_AdminPageFramework_Registry::URI, 'sScriptName' => CustomScrollbar_AdminPageFramework_Registry::NAME, 'sLibraryName' => CustomScrollbar_AdminPageFramework_Registry::NAME, 'sLibraryURI' => CustomScrollbar_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => CustomScrollbar_AdminPageFramework_Registry::getVersion(), 'sDescription' => CustomScrollbar_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => CustomScrollbar_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => CustomScrollbar_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => CustomScrollbar_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => CustomScrollbar_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);

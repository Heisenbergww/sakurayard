...
abstract class CustomScrollbar_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'CustomScrollbar_AdminPageFramework_Form_', 'oPageLoadInfo' => 'CustomScrollbar_AdminPageFramework_PageLoadInfo_', 'oResource' => 'CustomScrollbar_AdminPageFramework_Resource_', 'oHelpPane' => 'CustomScrollbar_AdminPageFramework_HelpPane_', 'oLink' => 'CustomScrollbar_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'CustomScrollbar_AdminPageFramework_Debug', 'oUtil' => 'CustomScrollbar_AdminPageFramework_FrameworkUtility', 'oMsg' => 'CustomScrollbar_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(CustomScrollbar_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return CustomScrollbar_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class CustomScrollbar_AdminPageFramework_Factory_View extends CustomScrollbar_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new CustomScrollbar_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }

...
class CustomScrollbar_AdminPageFramework_AdminNotice___Script extends CustomScrollbar_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.custom-scrollbar-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='custom-scrollbar-admin-notice-animation-container'></div>" );

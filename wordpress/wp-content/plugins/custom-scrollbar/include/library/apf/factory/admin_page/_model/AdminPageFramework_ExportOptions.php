...
abstract class CustomScrollbar_AdminPageFramework_CustomSubmitFields extends CustomScrollbar_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class CustomScrollbar_AdminPageFramework_ExportOptions extends CustomScrollbar_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo CustomScrollbar_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':

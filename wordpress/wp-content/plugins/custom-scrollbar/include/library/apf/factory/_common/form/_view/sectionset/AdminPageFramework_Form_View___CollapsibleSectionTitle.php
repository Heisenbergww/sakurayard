...
class CustomScrollbar_AdminPageFramework_Form_View___Section_Base extends CustomScrollbar_AdminPageFramework_Form_Base {
    ...
    public function getFieldsetOutput($aFieldset) {
        ...
        $_oFieldset = new CustomScrollbar_AdminPageFramework_Form_View___Fieldset($aFieldset, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
        $_sFieldOutput = $_oFieldset->get();
        return $_sFieldOutput;
    }
}
class CustomScrollbar_AdminPageFramework_Form_View___SectionTitle extends CustomScrollbar_AdminPageFramework_Form_View___Section_Base {
    ...
    private function _getToolTip() {
        ...
        $_oToolTip = new CustomScrollbar_AdminPageFramework_Form_View___ToolTip($_aSectionset['tip'], $_sSectionTitleTagID);
    ...
    private function _getSectionTitleOutput($sTitle, $sTag, $aCollapsible) {
        return $sTitle ? "<{$sTag} class='section-title'>" . $this->_getCollapseButton($aCollapsible) . $sTitle . $this->_getToolTip() . "</{$sTag}>" : '';
    }
    private function _getCollapseButton($aCollapsible) {
        ...
        return $this->getAOrB('button' === $this->getElement($aCollapsible, 'type', 'box'), "<span class='custom-scrollbar-collapsible-button custom-scrollbar-collapsible-button-expand' title='{$_sExpand}'>&#9658;</span>" . "<span class='custom-scrollbar-collapsible-button custom-scrollbar-collapsible-button-collapse' title='{$_sCollapse}'>&#9660;</span>", '');
    }
    ...
    private function _getFieldsetsInSectionTitleArea(array $aFieldsets, $iSectionIndex, $aFieldTypeDefinitions) {
        ...
        foreach ($aFieldsets as $_aFieldset) {
            ...
            $_oFieldsetOutputFormatter = new CustomScrollbar_AdminPageFramework_Form_Model___Format_FieldsetOutput($_aFieldset, $iSectionIndex, $aFieldTypeDefinitions);

...
class CustomScrollbar_AdminPageFramework_WPUtility_URL extends CustomScrollbar_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(CustomScrollbar_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(CustomScrollbar_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = CustomScrollbar_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class CustomScrollbar_AdminPageFramework_WPUtility_Page extends CustomScrollbar_AdminPageFramework_WPUtility_HTML {
...
class CustomScrollbar_AdminPageFramework_WPUtility_Hook extends CustomScrollbar_AdminPageFramework_WPUtility_Page {
...
class CustomScrollbar_AdminPageFramework_WPUtility_File extends CustomScrollbar_AdminPageFramework_WPUtility_Hook {
...
class CustomScrollbar_AdminPageFramework_WPUtility_Option extends CustomScrollbar_AdminPageFramework_WPUtility_File {
...
class CustomScrollbar_AdminPageFramework_WPUtility_Meta extends CustomScrollbar_AdminPageFramework_WPUtility_Option {
...
class CustomScrollbar_AdminPageFramework_WPUtility_SiteInformation extends CustomScrollbar_AdminPageFramework_WPUtility_Meta {
...
class CustomScrollbar_AdminPageFramework_WPUtility_SystemInformation extends CustomScrollbar_AdminPageFramework_WPUtility_SiteInformation {

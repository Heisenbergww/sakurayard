...
/**
	...
	Copyright (c) 2013-2016, Michael Uno; Licensed under MIT <http://opensource.org/licenses/MIT> Included Components: Admin Pages, Utilities
 Generated on 2016-10-08 */
if (!class_exists('CustomScrollbar_AdminPageFramework_Registry', false)):
    abstract class CustomScrollbar_AdminPageFramework_Registry_Base {
        const VERSION = '3.8.7b02';
    ...
    final class CustomScrollbar_AdminPageFramework_Registry extends CustomScrollbar_AdminPageFramework_Registry_Base {
        ...
        static public function setUp($sFilePath = __FILE__) {
            ...
            self::$bIsMinifiedVersion = class_exists('CustomScrollbar_AdminPageFramework_MinifiedVersionHeader', false);
            self::$bIsDevelopmentVersion = isset(self::$aClassFiles['CustomScrollbar_AdminPageFramework_InclusionClassFilesHeader']);
        }
...
if (!class_exists('CustomScrollbar_AdminPageFramework_Bootstrap', false)):
    final class CustomScrollbar_AdminPageFramework_Bootstrap {
        ...
        private function _include() {
            ...
            new CustomScrollbar_AdminPageFramework_RegisterClasses('', array('exclude_class_names' => array('CustomScrollbar_AdminPageFramework_MinifiedVersionHeader', 'CustomScrollbar_AdminPageFramework_BeautifiedVersionHeader',),), CustomScrollbar_AdminPageFramework_Registry::$aClassFiles);
            self::$_bXDebug = isset(self::$_bXDebug) ? self::$_bXDebug : extension_loaded('xdebug');
            if (self::$_bXDebug) {
                new CustomScrollbar_AdminPageFramework_Utility;
                new CustomScrollbar_AdminPageFramework_WPUtility;
            }
        }

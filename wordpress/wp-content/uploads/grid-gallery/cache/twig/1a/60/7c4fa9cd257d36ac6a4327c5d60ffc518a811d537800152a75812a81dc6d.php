...
/* @promo/promo.twig */
class __TwigTemplate_1a607c4fa9cd257d36ac6a4327c5d60ffc518a811d537800152a75812a81dc6d extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo "
                        ...
                        <h4>
                            ";
        // line 51
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "translate", array(0 => "Gallery doesn’t load on the front end. If the loading gallery icon just keeps playing but never loads the gallery."), "method"), "html", null, true);
        echo "
                        </h4>
                        <p>
\t\t\t\t\t\t\tMost likely there are conflicts with your theme or other plugins. Please contact us through our <a href=\"//supsystic.com/contact-us/\" target=\"_blank\">internal support</a>. We will check what is wrong and will help you to solve the problem.
                        ...
                        <h4>
                            ";
        // line 58
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "translate", array(0 => "How to change the position of photos in gallery?"), "method"), "html", null, true);
        echo "
                        </h4>
                        <p>
...
\t\t\t\t\t\t
                        <h4>
                            ";
        // line 65
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "translate", array(0 => "How to insert gallery into widget?"), "method"), "html", null, true);
        echo "
                        </h4>
                         <p>
\t\t\t\t\t\t\tIf you want to use gallery in widgets - 
                            <ol>
                                <li>";
        // line 70
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "translate", array(0 => "Go to Appearance -> Widgets."), "method"), "html", null, true);
        echo "</li>
                                <li>";
        // line 71
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "translate", array(0 => "You’ll see Gallery by Supsystic Widget on the left. Drag it to the area, where you want it to appear."), "method"), "html", null, true);
        echo "</li>
                                <li>";
        // line 72
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "translate", array(0 => "Then choose what gallery you want to display. And press save."), "method"), "html", null, true);
        echo "</li>
                            </ol>
                        </p>
        ...
        // line 77
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "translate", array(0 => "Check all other FAQs"), "method"), "html", null, true);
        echo "</a>
                        </h4>
...
";
    ...
    {
        return array (  163 => 82,  159 => 81,  152 => 77,  144 => 72,  140 => 71,  136 => 70,  128 => 65,  118 => 58,  108 => 51,  101 => 47,  86 => 35,  77 => 29,  72 => 27,  65 => 23,  60 => 21,  49 => 13,  39 => 10,  31 => 4,  28 => 3,);
    }
}
